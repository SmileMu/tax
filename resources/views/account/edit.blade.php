                ...
                <div class="card-body">
                    ...
                    <form class="form"
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <select name="name"  value="{{$account ->bank_name}}"id="" class="form-control ">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                ...
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="account_number"  value="{{$account ->accountNumber}}" required type="text">
                            </div>
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="">
                                <label> الرصيد الافتتاحي</label>
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="balance" value="{{$account ->balance}}" required type="text">
                            </div>
