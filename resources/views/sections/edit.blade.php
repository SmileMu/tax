...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تعديل قطاع المؤسسات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل
                قطاع</span>
            </div>
        </div>
    </div>
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                       name="type" required type="text" value="{{$type -> section_type}}">
                            </div>
