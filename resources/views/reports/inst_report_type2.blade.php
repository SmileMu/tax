    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="my-auto">
            <div class="d-flex ">
                <h5 class="content-title mb-0 my-auto text-center"> تقرير عن المؤسسات الحكومية</h5>
            </div>
        </div><br>
                        ...
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                            ...
                            @foreach ($institution as $institutions)
                                <tr>
                                    ...
                                    <td>{{ $institutions->found_year }}</td>
                                    <td>{{ $institutions-> type ? $institutions -> type -> type_name : 'بدون' }}</td>
                                    <td>{{ $institutions -> section ? $institutions -> section -> section_type : 'بدون' }}</td>
                                    {{--                                    <td>{{$institutions ->type->type_name ?? 'N/A'}}</td>--}}
                                    {{--                                    <td>{{$institutions->section->section_type ?? 'N/A'}}</td>--}}
                                    <td>{{ $institutions->location }}</td>
                                    <td>{{ $institutions->phone_no }}</td>
