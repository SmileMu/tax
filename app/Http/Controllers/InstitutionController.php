...
class InstitutionController extends Controller
{
    ...
    {
        $institution=  Institution::where("inst_name","=",'بنك الخرطوم')->get();
        return view('reports.show_emp_inst', compact('institution'));
    }


    public function institution_report_type()
    {
        $institution=  Institution::where("type_id","=",5)->get();
        return view('reports.inst_report_type', compact('institution'));
    }


    public function institution_report_type2()
    {
        $institution=  Institution::where("type_id","=",6)->get();
        return view('reports.inst_report_type2', compact('institution'));
    }
